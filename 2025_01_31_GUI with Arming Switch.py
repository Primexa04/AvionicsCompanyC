...
# Function to update arm or disarm status
...
# Create Tkinter button to toggle arm/disarm status
arming_button = tk.Button(display_frame, text="Toggle Arm/Disarm", command=toggle_arming_switch, bg="blue", fg="white")
