...
def connect_mavlink():
    ...
    return mavutil.mavlink_connection('COM7')  # Adjust connection type as needed
...
control_surfaces = [
    ...
    {"label": "Elevator",          "servos": [2],    "min": -40, "max": 40},
...
servo_calibrations = {
    ...
    5: {"calibration": [(-30, 2020), (0, 1670), (30, 1320)]},  # Starboard aileron
    6: {"calibration": [(0, 650), (30, 2450)]},  # Starboard Flap inboard
    7: {"calibration": [(0, 2450), (30, 1650)]},  # Starboard Flap outboard
...
def send_specific_angle():
    ...
    try:
        ...
        surface_mapping = {
            ...
            "Elevator": {"servos": [2], "min": -40, "max": 40},
